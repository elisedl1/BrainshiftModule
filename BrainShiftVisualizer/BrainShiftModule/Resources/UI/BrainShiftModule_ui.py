...
class Ui_BrainShiftModule(object):
    def setupUi(self, BrainShiftModule):
        ...
        BrainShiftModule.resize(586, 482)
        ...
        self.formLayout.setWidget(13, QtWidgets.QFormLayout.SpanningRole, self.loadDisplacementVolumeButton)
        ...
        self.formLayout.setWidget(15, QtWidgets.QFormLayout.FieldRole, self.colorMapSelector)
        ...
        self.formLayout.setWidget(12, QtWidgets.QFormLayout.SpanningRole, self.existingDisplacementVolumeSelector)
